...
- Xây dựng backend API bằng FastAPI để quản lý các chức năng chính của hệ thống.
- Thiết kế cơ sở dữ liệu lưu thông tin người dùng, khóa học, tài liệu và lịch sử hỏi đáp.
- Xây dựng chức năng tải lên tài liệu học tập ở các định dạng phổ biến như PDF, DOCX và TXT.
- Xây dựng module đọc, làm sạch và chuẩn hóa nội dung tài liệu sau khi tải lên.
- Chia nội dung tài liệu thành các đoạn nhỏ phù hợp cho quá trình tìm kiếm ngữ nghĩa.
- Tạo embedding cho các đoạn văn bản bằng mô hình hỗ trợ đa ngôn ngữ, phù hợp với tài liệu tiếng Việt.
- Lưu trữ embedding và metadata tài liệu trong ChromaDB để phục vụ truy xuất.
- Xây dựng chức năng tìm kiếm các đoạn tài liệu liên quan theo câu hỏi của người dùng.
- Tích hợp mô hình ngôn ngữ Gemini để sinh câu trả lời dựa trên ngữ cảnh được truy xuất.
- Trả lời câu hỏi kèm nguồn tham khảo và lưu lại lịch sử hỏi đáp để làm nền tảng cho chức năng cá nhân hóa về sau.
...
- Phần mở đầu trình bày lý do chọn đề tài, mục tiêu, phương pháp thực hiện, đối tượng và phạm vi thực hiện, cùng bố cục tổng quát của báo cáo.
- Chương 1 trình bày tổng quan về đề tài và cơ sở lý thuyết liên quan, bao gồm chatbot, mô hình ngôn ngữ lớn, embedding, vector database và kiến trúc Retrieval-Augmented Generation.
- Chương 2 trình bày phân tích yêu cầu và thiết kế hệ thống, bao gồm yêu cầu chức năng, yêu cầu phi chức năng, kiến trúc tổng thể, thiết kế cơ sở dữ liệu và thiết kế các thành phần xử lý chính.
- Chương 3 trình bày quá trình triển khai hệ thống, bao gồm xây dựng backend API, xử lý tài liệu, tạo chunk, embedding, lưu trữ vector, retrieval, tích hợp LLM và xây dựng API chat.
- Chương 4 trình bày kết quả thực nghiệm, minh chứng chức năng, đánh giá kết quả đạt được, các hạn chế còn tồn tại và hướng cải thiện.
- Phần kết luận tổng hợp các kết quả đã đạt được, rút ra bài học trong quá trình thực tập và đề xuất hướng phát triển tiếp theo cho hệ thống.
